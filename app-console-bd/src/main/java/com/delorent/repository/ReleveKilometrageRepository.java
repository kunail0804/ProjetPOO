...
public class ReleveKilometrageRepository {
    ...
    private static final String T = "RELEVE_KILOMETRAGE";
    ...
    private ReleveKilometrage map(ResultSet rs) throws SQLException {
        int idReleve = rs.getInt("idReleve");
        int idContrat = rs.getInt("idContrat");
        ReleveType type = ReleveType.valueOf(rs.getString("typeReleve"));
        int km = rs.getInt("kilometrage");
        ...
        return new ReleveKilometrage(idReleve, idContrat, type, km, path, date);
    }
}