...
public class UtilisateurRepository implements RepositoryBase<Utilisateur, Long> {
    ...
    private Utilisateur mapRow(ResultSet rs) throws java.sql.SQLException {
    ...
    public List<Utilisateur> getAll() {
        String sql = "SELECT " + COL_ID + ", " + COL_MAIL + ", " + COL_MDP + ", " + COL_ADR + ", " + COL_VILLE + ", " + COL_CP + ", " + COL_REGION + ", " + COL_TEL +
                     " FROM " + TABLE;
    ...
    public Utilisateur get(Long id) {
        String sql = "SELECT " + COL_ID + ", " + COL_MAIL + ", " + COL_MDP + ", " + COL_ADR + ", " + COL_VILLE + ", " + COL_CP + ", " + COL_REGION + ", " + COL_TEL +
                     " FROM " + TABLE +
                     " WHERE " + COL_ID + " = ?";
        List<Utilisateur> res = jdbcTemplate.query(sql, (rs, rowNum) -> mapRow(rs), id);
    ...
    public boolean modify(Utilisateur entity) {
        String sql = "UPDATE " + TABLE +
                     " SET " + COL_MAIL + " = ?, " + COL_MDP + " = ?, " + COL_ADR + " = ?, " + COL_VILLE + " = ?, " + COL_CP + " = ?, " + COL_REGION + " = ?, " + COL_TEL + " = ? " +
                     "WHERE " + COL_ID + " = ?";
